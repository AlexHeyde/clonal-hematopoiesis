...
b = 365/280;  % Average baseline HSC proliferation rate
...
s = .03;      % Selective effect of the largest driver clone
...
%- Healthy individuals
r = [0.4883	1.8066	0.9861	0.9861	0.9151	1.0966	0.2832	0.6453	1.9959	0.7968];
...
%- CVD individuals
r = [1.9328	2.2878	1.6961	3.8025	1.4595	3.3843	1.7908	3.7393	1.9170	2.8637];
